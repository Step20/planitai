    ...
    <>
      ...
      <div className="text-center py-20 bg-zinc-100 border-t border-gray-200">
        <h2 className="text-2xl md:text-3xl text-black font-semibold text-center mb-3">
          Connect to PlanIt today
        </h2>
        <p className="mb-6 text-gray-700 w-170 mx-auto">
          Make sure you’re connected to PlanIt to get itineraries created for
          you as soon as you book, and receive a complimentary subscription to
          PlanIt Pro, if you’re eligible.
        </p>
